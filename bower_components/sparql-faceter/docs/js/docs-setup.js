NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "keywords": "api configuration dates default defines directive disabled displayed earliest enabled facet facetedsearch facets friendly generates latest object options path patterns predicate property queries range ranges seco selectable selected selecting set sparql start structure title triple undefined unique usable users values variable"
    },
    {
      "section": "api",
